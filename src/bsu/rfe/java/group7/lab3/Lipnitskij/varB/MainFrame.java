...
import bsu.rfe.java.group7.lab3.Lipnitskij.varB.MainFrame;
...
public class MainFrame extends JFrame {
	...
	private TCellRander render = new TCellRander();
	...
	public MainFrame(Double[] coefficients) {
		...
		saveToGraphicsMenuItem = fileMenu.add(saveToGraphicstAction);
		...
		public void actionPerformed(ActionEvent ev) {
			try {
				...
				data = new TableModel(from, to, step,MainFrame.this.coefficients);
